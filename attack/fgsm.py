...
Code sorce: https://github.com/tensorflow/cleverhans/tree/master/cleverhans/future/tf2/attacks
"""
...
def FGSM(model_fn, x, eps, norm, clip_min=None, clip_max=None, y=None,
                         targeted=False, sanity_checks=False):
  """
  Tensorflow 2.0 implementation of the Fast Gradient Sign Method.
